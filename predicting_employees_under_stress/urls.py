"""predicting_employees_under_stress URL Configuration
...
from predicting_employees_under_stress  import settings
...
urlpatterns = [
    ...
    url(r'^Employee_Stress_Prediction_Type/$', remoteuser.Employee_Stress_Prediction_Type, name="Employee_Stress_Prediction_Type"),
    ...
    url(r'^View_Employee_Stress_Prediction_Type_Ratio/$', serviceprovider.View_Employee_Stress_Prediction_Type_Ratio, name="View_Employee_Stress_Prediction_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Employee_Stress_Prediction_Type/$', serviceprovider.View_Employee_Stress_Prediction_Type, name="View_Employee_Stress_Prediction_Type"),
